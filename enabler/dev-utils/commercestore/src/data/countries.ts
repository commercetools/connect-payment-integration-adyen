...
export const COUNTRY_CURRENCY: Record<string, string> = {
  ...
  FR: 'EUR', DE: 'EUR', IT: 'EUR', JP: 'JPY', NL: 'EUR', NO: 'NOK',
  PL: 'PLN', PT: 'EUR', ES: 'EUR', SE: 'SEK', CH: 'CHF',
  GB: 'GBP', US: 'USD',
};

export const SHIPPING_COST_BY_CURRENCY: Record<string, number> = {
  EUR: 500, USD: 600, GBP: 400, CNY: 3500, DKK: 3500, JPY: 700, NOK: 4900,
...
export const COUNTRIES: Country[] = [
  ...
  { code: 'JP', name: 'Japan',          currency: 'JPY', taxRate: 0.10,  taxName: 'CT'  },
